...
export function createUIController({ callAIAgent, buildAffiliateLink }) {
  ...
  function renderToolkitConsole(toolId) {
    ...
    const laptopOptions = STATE.data.allLaptops
      ...
      .join('');
    const toolUIs = {
      'deal-assassin': `<div class="flex-grow flex flex-col"><label class="mb-2">Product Name:</label><input aria-label="input" type="text" id="tool-input-query" placeholder="e.g., Illegear Z7" class="w-full mb-4" /><button data-tool-action="deal-assassin" class="action-button mt-auto">✨ Find Best Deal</button></div>`,
      ...
      'elite-procurement': `<div class="flex-grow flex flex-col"><label class="mb-2">Rare Item:</label><input aria-label="input" type="text" id="tool-input-item" placeholder="e.g., Razer Blade 16 Mini-LED" class="w-full mb-4" /><button data-tool-action="elite-procurement" class="action-button mt-auto">✨ Initiate Scan</button></div>`,
      'component-recon': `<div class="flex-grow flex flex-col"><label class="mb-2">Component Model:</label><input aria-label="input" type="text" id="tool-input-component" placeholder="e.g., Core Ultra 9 185H" class="w-full mb-4" /><button data-tool-action="component-recon" class="action-button mt-auto">✨ Run Recon</button></div>`,
      ...
      'ecosystem-architect': `<div class="flex-grow flex flex-col"><label class="mb-2">Current Devices:</label><input aria-label="input" type="text" id="tool-input-devices" placeholder="e.g., iPhone 15 Pro, iPad Air" class="w-full mb-4" /><button data-tool-action="ecosystem-architect" class="action-button mt-auto">✨ Find Best Fit</button></div>`,
